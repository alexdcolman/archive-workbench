...
**Versión de referencia:** 0.89.0 RC82
...
1. Completar y validar `OPS-01`: validar RC82 primero en Windows CPU sobre registro inicial del proyecto, Google Drive, copias audiovisuales sin originales y latencia de cambio de sección; sólo después continuar Windows GPU y macOS. RC80 quedó materialmente verde en Linux y RC81 ya fue publicada.
