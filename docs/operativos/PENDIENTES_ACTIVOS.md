...
- **OPS-01-CALLBACK:** validar que el retorno de **Conectar Google Drive** o **Elegir ZIP en Google Drive** quede en una pantalla auxiliar terminal y no muestre el launcher. **Criterio de cierre:** la pestaña auxiliar informa el resultado, la pestaña original conserva el proyecto abierto y la selección de Picker puede usarse normalmente;
