...
def test_authority_relation_profile_migration_adds_nullable_json_columns(tmp_path: Path) -> None:
    from sqlalchemy import inspect

    root = tmp_path / "profile_migration"
    upgrade_database(root, revision="0046_audiovisual_timeline_annotations")
    ...
    assert "profile_json" in authority_columns
