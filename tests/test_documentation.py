...
def test_current_update_guide_describes_0890_rc81_windows_candidate() -> None:
    ...
    assert "Archive Workbench 0.89.0 RC81" in text
    assert "0.89.0-rc81-cpu" in text
    assert "0.89.0-rc81-gpu" in text
    ...
    assert "0.89.0 RC81" in continuity
    ...
    assert "Distribución administrada y espacio de trabajo multiplataforma - RC72/RC81" in architecture
