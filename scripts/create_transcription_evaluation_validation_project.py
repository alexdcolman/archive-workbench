...
def create_validation_project(source: Path, destination: Path) -> dict[str, object]:
    ...
    if revision not in {"0045_audiovisual_transcription", "0046_audiovisual_timeline_annotations", "0048_catalog_document_components", "0049_external_analysis_layer", "0050_external_analysis_continuity"}:
