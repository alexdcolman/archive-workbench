...
class EditableExportSummary:
    ...
    layout_structures_path: Path
    object_count: int
    revision_count: int
    comment_count: int
    tag_count: int
    form_structure_count: int
    layout_structure_count: int
...
def _append_page_revision(
    ...
    *,
    ...
    revision = EditablePageRevision(
        ...
        layout_structure_json=page.layout_structure_json or {},
    ...
    *,
    ...
    layout_structure_exports = [
        EditableLayoutStructureExport(
            ...
            page=item.page_number,
            revision_number=item.revision_number,
            structure=item.layout_structure_json or {},
        )
        for item in pages
        if (item.layout_structure_json or {}).get("columns")
    ]
    ...
    layout_structures_path = output_root / "layout_structures.jsonl"
    ...
    write_models_atomic(layout_structures_path, layout_structure_exports)
    ...
    manifest = EditableExportManifest(
        ...
        layout_structure_count=len(layout_structure_exports),
        ...
        layout_structures_path=layout_structures_path.name,
    )
    ...
    return EditableExportSummary(
        ...
        layout_structures_path=layout_structures_path,
        object_count=len(objects),
        revision_count=len(revisions),
        comment_count=len(comments),
        tag_count=len(tags),
